...
public class DriveConstants {
    ...
    public static double GEAR_RATIO = 1 * 1.12454142762; // output (wheel) speed / input (motor) speed
    public static double TRACK_WIDTH = 14.43; // in
     ...
     * empirically tuned.
     */
    public static double kV = 0.0172; // maybe change to positive original negativife
